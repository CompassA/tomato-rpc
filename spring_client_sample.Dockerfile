...
# docker run --env JAVA_OPTIONS="-Dtomato-rpc.name-service-uri=172.17.0.3:2181 -Dspring.profiles.active=prod -Dtomato-rpc.client-mode=router"  -d compassa/rpc-sample-server:1.0.3
